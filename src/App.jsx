...
export default function App() {
  ...
  return (
    <div className="bb-root" style={{ fontFamily: "system-ui, sans-serif", background: T.bg, color: T.txt, display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* HEADER */}
      <div style={{ background: `linear-gradient(135deg,${T.priDk},${T.pri})`, color: "#fff", padding: "calc(10px + env(safe-area-inset-top, 0px)) 16px 10px", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
        {view === "map" ? (
          <>
